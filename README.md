...
**If you purchased a Clima.Pro Kit we will be sending you an updated PCB soon!** - Update 2022.07.10: Best news! We've got new boards assembled for you! We just need to test them before they go out. We're working on getting the test harness together (we have a diagnostic app, but need to add the solar stuff to it).
