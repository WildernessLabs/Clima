...
**Clima** is an open-source project by [Wilderness Labs](https://www.wildernesslabs.co/) and we encourage community feedback and contributions.
...
1. All PRs should target the `develop` branch on the Clima repository.
...
2. Clone your fork locally: `git clone https://github.com/WildernessLabs/Clima`
...
7. Open a pull request at [Clima/pulls](https://github.com/WildernessLabs/Clima/pulls) targetting the `develop` branch
## Need Help?
